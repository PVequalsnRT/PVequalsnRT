...
<body>
    <div class="container-fluid">
        ...
        <nav class=" v10 navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto flex justify-content-end" id="navBar">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="index.php">BackOffice</a>
                    </li>
        ...
        <!-- main -->
        <main class="v70 bg-light p-5">
            <div class="row col-md mx_auto justify-content-center">